...
echo hasPath($matrix, $rows, $cols, $str) == true; // 1(true)
echo '<br />';

$str2 = 'abtg';
echo hasPath($matrix, $rows, $cols, $str2) == true; // 1(true)
echo '<br />';

$str3 = 'abge';
echo hasPath($matrix, $rows, $cols, $str3) == false; // 1(true)
